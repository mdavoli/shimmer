 ...
 * Slug: shimmer/general-testimonials-image-contrast-background
...
<p style="margin-top:0"><?php echo esc_html__( 'With its clean, minimal design and powerful features, Shimmer enables agencies to build cool websites.', 'shimmer' ); ?></p>
<!-- /wp:paragraph -->
